 ...
 * @group full
 */
class TocMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'toc-macro-input.xml' => 'toc-macro-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		$tocUsage = new \HalloWelt\MigrateConfluence\Utility\TocMacroUsage();

		return new TocMacro( $tocUsage );
	}
