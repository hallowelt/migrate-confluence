 ...
 * @group full
 */
class DrawioSketchMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'drawio-sketch-macro-input.xml' => 'drawio-sketch-macro-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		$writerPath = $tmpBase . '/macro-chain-writer-drawio-sketch';
		...
		return new DrawioSketchMacro( $dataLookup, $conversionDataWriter, 42, 'SomePage' );
	}
