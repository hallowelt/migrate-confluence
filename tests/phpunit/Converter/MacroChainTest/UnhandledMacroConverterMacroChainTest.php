 ...
 * @group full
 */
class UnhandledMacroConverterMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\UnhandledMacroConverter::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'unhandled-macro-input.xml' => 'unhandled-macro-output.wikitext',
		];
