 ...
 * @group full
 */
class TmMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'tm-standard-input.xml' => 'tm-standard-output.wikitext',
			'tm-with-attrs-input.xml' => 'tm-with-attrs-output.wikitext',
			'tm-nobody-input.xml' => 'tm-nobody-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		return new TmMacro( $this->createMock( IConverterDataWriter::class ), 1 );
	}
