 ...
 * @group full
 */
class LayoutSectionMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\LayoutSection::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'layout-section-input.xml' => 'layout-section-output.wikitext',
		];
