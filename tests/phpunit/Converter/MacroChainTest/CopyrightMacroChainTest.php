 ...
 * @group full
 */
class CopyrightMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'copyright-standard-input.xml' => 'copyright-standard-output.wikitext',
			'copyright-with-attrs-input.xml' => 'copyright-with-attrs-output.wikitext',
			'copyright-nobody-input.xml' => 'copyright-nobody-output.wikitext',
		];
