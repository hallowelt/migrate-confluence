 ...
 * @group full
 */
class ChildrenMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'children-macro-input.xml' => 'children-macro-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new ChildrenMacro( 42, 'SomePage', $dataReader );
	}
