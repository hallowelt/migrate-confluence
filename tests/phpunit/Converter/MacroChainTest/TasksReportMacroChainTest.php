 ...
 * @group full
 */
class TasksReportMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\TasksReportMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'task-report-macro-preserve-input.xml' => 'task-report-macro-preserve-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new TasksReportMacro( $dataReader );
	}
