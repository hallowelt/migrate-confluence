 ...
 * @group full
 */
class ViewDocMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\ViewDocMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'view-doc-macro-input.xml' => 'view-doc-macro-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new ViewDocMacro( $dataReader, 42, 'SomePage', $migrationConfig );
	}
