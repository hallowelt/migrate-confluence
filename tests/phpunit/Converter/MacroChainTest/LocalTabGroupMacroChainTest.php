 ...
 * @group full
 */
class LocalTabGroupMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\LocalTabGroupMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'local-tab-group-macro-input.xml' => 'local-tab-group-macro-output.wikitext',
		];
