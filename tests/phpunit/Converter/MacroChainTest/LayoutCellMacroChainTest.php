 ...
 * @group full
 */
class LayoutCellMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\LayoutCell::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'layout-cell-input.xml' => 'layout-cell-output.wikitext',
		];
