 ...
 * @group full
 */
class PageLinkMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'pagelinktest-input.xml' => 'pagelinktest-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new PageLink( $dataLookup, 42, 'SomePage', $migrationConfig );
	}
