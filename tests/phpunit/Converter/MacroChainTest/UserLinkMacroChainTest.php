 ...
 * @group full
 */
class UserLinkMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\UserLink::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'userlinktest-input.xml' => 'userlinktest-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new UserLink( $dataLookup, 42, 'SomePage', $migrationConfig );
	}
