 ...
 * @group full
 */
class SpaceDetailsMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\SpaceDetailsMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'space-details-macro-input.xml' => 'space-details-macro-output.wikitext',
		];
