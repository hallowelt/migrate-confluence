 ...
 * @group full
 */
class CodeMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'code-nobody-input.xml' => 'code-nobody-output.wikitext',
			'code-standard-input.xml' => 'code-standard-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		return new CodeMacro( $this->placeholderManager );
	}
