 ...
 * @group full
 */
class AnchorMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'anchor-macro-broken-input.xml' => 'anchor-macro-broken-output.wikitext',
			'anchor-macro-input.xml' => 'anchor-macro-output.wikitext',
		];
