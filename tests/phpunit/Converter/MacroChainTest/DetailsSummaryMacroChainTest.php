 ...
 * @group full
 */
class DetailsSummaryMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'details-summary-macro-input.xml' => 'details-summary-macro-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new DetailsSummaryMacro();
	}
