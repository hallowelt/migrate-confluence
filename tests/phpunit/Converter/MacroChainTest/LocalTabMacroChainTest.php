 ...
 * @group full
 */
class LocalTabMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\LocalTabMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'local-tab-macro-input.xml' => 'local-tab-macro-output.wikitext',
		];
