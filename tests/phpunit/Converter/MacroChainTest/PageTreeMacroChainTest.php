 ...
 * @group full
 */
class PageTreeMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'pagetree-macro-input.xml' => 'pagetree-macro-output.wikitext',
			'pagetree-macro-no-spacekey-input.xml' => 'pagetree-macro-no-spacekey-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new PageTreeMacro( $dataReader, 42, 'SomePage', 'SomePage' );
	}
