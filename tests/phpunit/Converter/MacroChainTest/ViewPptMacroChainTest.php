 ...
 * @group full
 */
class ViewPptMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\ViewPptMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'view-ppt-macro-input.xml' => 'view-ppt-macro-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new ViewPptMacro( $dataReader, 42, 'SomePage', $migrationConfig );
	}
