 ...
 * @group full
 */
class ContentByLabelMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\ContentByLabelMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'contentbylabel-macro-input.xml' => 'contentbylabel-macro-output.wikitext',
		];
