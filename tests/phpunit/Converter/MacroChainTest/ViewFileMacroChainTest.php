 ...
 * @group full
 */
class ViewFileMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'view-file-macro-broken-input.xml' => 'view-file-macro-broken-output.wikitext',
			'view-file-macro-input.xml' => 'view-file-macro-output.wikitext',
			'view-file-macro-unmapped-input.xml' => 'view-file-macro-unmapped-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new ViewFileMacro( $dataLookup, 42, 'SomePage', $migrationConfig );
	}
