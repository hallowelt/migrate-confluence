 ...
 * @group full
 */
class MultimediaMacroChainTest extends MacroChainTestBase {
	...
	public function testMacroChain(): void {
		...
		$fixtures = [
			'multimedia-macro-broken-input.xml' => 'multimedia-macro-broken-output.wikitext',
			'multimedia-macro-input.xml' => 'multimedia-macro-output.wikitext',
			'multimedia-macro-unmapped-input.xml' => 'multimedia-macro-unmapped-output.wikitext',
		];
	...
	private function createProcessor(): IProcessor {
		...
		return new MultimediaMacro( $dataReader, 0, 'SomePage', $migrationConfig );
	}
