 ...
 * @group full
 */
class WidgetMacroChainTest extends MacroChainTestBase {

	/**
	 * @covers HalloWelt\MigrateConfluence\Converter\Processor\WidgetMacro::process
	 * @return void
	 */
	public function testMacroChain(): void {
		$dir = dirname( __DIR__, 2 ) . '/data';
		$fixtures = [
			'widget-macro-input.xml' => 'widget-macro-output.wikitext',
		];
