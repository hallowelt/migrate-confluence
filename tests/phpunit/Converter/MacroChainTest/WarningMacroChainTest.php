 ...
 * @group full
 */
class WarningMacroChainTest extends MacroChainTestBase {
...
XML,
		...
		if ( $executedAssertions === 0 ) {
			$fallbackXml = '<?xml version="1.0" encoding="UTF-8"?><root xmlns:ac="some" xmlns:ri="thing"><p>Fallback fixture for WarningMacro.</p></root>';
