...
class UpdatePagesTableWithWikiTitleTest extends TestCase {
	...
	public function testBuildsWikiTitleForCurrentTopLevelPage(): void {
		...
		$workspaceDB->addPage( 400, 42, 'Sample page', '', 'current', '', '', '1', -1, -1, [], [], [], [] );
		...
		$this->assertNotSame( '', $page['wiki_title'], 'Expected wiki_title to be generated.' );
		$this->assertStringStartsWith( 'TEST:', $page['wiki_title'], 'Expected generated wiki_title to use TEST namespace.' );
	}
}
