...
class WorkspaceDB {
	 ...
	 * @return string|null
	 */
	public function getInterwikiBlogPostTitleFromSpaceId( int $spaceId, string $confluenceTitle ): ?string {
		return $this->getInterwikBlogPostTitleFromSpaceId( $spaceId, $confluenceTitle );
	}
